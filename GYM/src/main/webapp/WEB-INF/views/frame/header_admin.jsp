                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
						...
						<c:if test="${adminLoginSession eq null}">
							<li><a class="dropdown-item" href="<c:url value="/admin/login"/>" class="login">Login</a></li>
						</c:if>
						<c:if test="${adminLoginSession ne null}">
							<li><a class="dropdown-item" href="<c:url value="/admin/logout"/>" class="login">Logout</a></li>
