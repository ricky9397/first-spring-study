...
<!-- 지도[s] -->    
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=3d71f1cfe16e8d41c79770b0875bbc83"></script>
    <script>
        var container = document.getElementById('map'); //지도 표시 div
        var options = {
            center: new kakao.maps.LatLng(200383.296935137, 452655.39803143), //지도의 중심좌표
            level: 3 //지도의 확대 레벨
        };
        ...
        // 마커가 표시될 위치
        var markerPosition  = new kakao.maps.LatLng(200383.296935137, 452655.39803143); 
