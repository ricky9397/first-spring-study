...
public abstract class BlockPadding {
   ...
   /**
    * To provide byte padding to create an instance. 'ANSI X.923' byte padding
    * provides a way.
    * 
   ...
   /**
    * To provide byte padding to create an instance. Byte padding to provide
    * that kind of 'ANSI X.923', 'ISO 10126', 'PKCS7' is.
    * 
    * @param type
    *            The type of padding bytes (ANSI X.923 : ANSIX923, ISO 10126 :
    *            ISO10126, PKCS7 : PKCS7)
    * @return Byte padding instance, if that does not support the null of the
    *         padding bytes is returned.
    */
